...
export default async function ProfileCard() {
  ...
  return (
    <div className="overflow-x-auto scrollbar-hide pl-4 pb-6">
  <div className="flex flex-nowrap gap-4">
    {profiles.map((item: Profile, index: number) => (
      <div
        key={item._id || index}
        className="w-[200px] bg-white rounded-2xl overflow-hidden relative flex-shrink-0 "
      >
        ...
        <div className="relative">
          ...
          {item.externalLink || (
            ...
            >
              <GoArrowUpRight className="text-gray-600 md:w-4 md:h-4" />
            </a>
          )}
        </div>
